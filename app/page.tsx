...
import { fetchNewArrivals, fetchTopSelling, getTopReviews } from '@/app/lib/model/data';
                ...
                <div className="bg-[rgba(240,240,240,1)]">
                    <div className="block md:grid md:grid-cols-2 max-w-96 md:max-w-[78rem] my-0 mx-auto">
                        <div className="flex flex-col justify-center items-start">
                            <h1 className="font-bold text-4xl md:text-6xl mb-8">FIND CLOTHES THAT MATCHES YOUR
                                STYLE</h1>
